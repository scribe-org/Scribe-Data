...
* The SPARQL queries for the Scribe-Data CLI are generated by a process that checks the available data via the Wikidata Query Service (`#617 <https://github.com/scribe-org/Scribe-Data/issues/617>`_).
* Scribe-Data can now be used to generate nine emojis per word instead of just three (`#670 <https://github.com/scribe-org/Scribe-Data/issues/670>`_).
...
* Testing for various parts of the CLI was expanded (`#623 <https://github.com/scribe-org/Scribe-Data/issues/623>`_).
