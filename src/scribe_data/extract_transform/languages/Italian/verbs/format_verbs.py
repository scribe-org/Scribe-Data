...
verbs_list, update_data_in_use, data_path= load_queried_data(file_path, language = "Italian", data_type = "verbs")
...
export_formatted_data(verbs_formatted, update_data_in_use, language = "Italian", data_type = "verbs")
