"""
Formats the Russian nouns queried from Wikidata using query_nouns.sparql.
"""
...
nouns_list, update_data_in_use, data_path= load_queried_data(file_path, language = "Russian", data_type = "nouns")
...
export_formatted_data(nouns_formatted, update_data_in_use, language = "Russian", data_type = "nouns")
