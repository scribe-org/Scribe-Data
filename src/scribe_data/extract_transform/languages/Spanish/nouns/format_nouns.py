...
nouns_list, update_data_in_use, data_path= load_queried_data(file_path, language = "Spanish", data_type = "nouns")
...
export_formatted_data(nouns_formatted, update_data_in_use, language = "Spanish", data_type = "nouns")
