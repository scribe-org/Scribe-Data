...
if "Russian/prepositions/" not in file_path:
    ...
    with open(
        "./Russian/prepositions/prepositions_queried.json", encoding="utf-8"
    ) as f:
        prepositions_list = json.load(f)
...
ios_data_dir_from_org = get_ios_data_path("Russian", "prepositions")
android_data_dir_from_org = get_android_data_path("Russian", "prepositions")
desktop_data_dir_from_org = get_desktop_data_path("Russian", "prepositions")
