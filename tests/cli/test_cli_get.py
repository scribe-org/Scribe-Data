...
class TestCLIGetData(unittest.TestCase):
    """
    ...
    def test_cli_get_emoji_keywords(self, generate_emoji: MagicMock) -> None:
        ...
        """
        get_data(languages=["English"], data_types=["emoji_keywords"])
        generate_emoji.assert_called_once_with(language="English")

    # MARK: Invalid Arguments

    def test_cli_get_invalid_arguments(self) -> None:
        """
    ...
    @patch("questionary.confirm")
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_user_skips_existing_file(
        self,
        mock_check_index: MagicMock,
        mock_questionary_confirm: MagicMock,
        mock_glob: MagicMock,
        ...
        result = get_data(languages=["English"], data_types=["nouns"])
    ...
    @patch("questionary.confirm")
    def test_cli_get_user_overwrites_existing_file(
        self,
        mock_questionary_confirm: MagicMock,
        mock_glob: MagicMock,
        mock_query_data: MagicMock,
    ...
    def test_cli_get_translations_with_specific_language(self, mock_parse):
        get_data(languages=["Spanish"], data_types=["translations"])
        mock_parse.assert_called_once_with(
            target_languages=["Spanish"], wiktionary_dump_path=None, overwrite=False
        )

    @patch("scribe_data.wiktionary.parse_translations.parse_wiktionary_translations")
    def test_cli_get_translations_with_dump(self, mock_parse):
        get_data(languages=["German"], data_types=["translations"])
        mock_parse.assert_called_once_with(
    ...
    def test_cli_get_all_languages_for_data_type_user_says_no(
        ...
        get_data(all_bool=True, data_types=["verbs"])
        mock_parse.assert_called_once_with(
            languages=["all"],
            data_types=["verbs"],
            wikidata_dump_type=["form"],
    ...
    def test_cli_get_all_languages_for_data_type_user_says_yes(
        ...
        get_data(all_bool=True, data_types=["verbs"])
        mock_query_data.assert_called_once_with(
            languages=["all"], data_types=["verbs"], overwrite=False
        )
    ...
    @patch("scribe_data.cli.get.query_data")
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_json_decode_error_handling(
    ...
    @patch("scribe_data.cli.get.query_data")
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_http_error_handling(
        self, mock_check_index: MagicMock, mock_query_data: MagicMock
    ) -> None:
        """
    ...
    @patch("scribe_data.cli.get.query_data")
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_endpoint_error_handling(
        self, mock_check_index: MagicMock, mock_query_data: MagicMock
    ) -> None:
        """
    ...
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_output_type_conversion(
        self,
        mock_check_index: MagicMock,
    ...
    @patch("scribe_data.cli.get.check_index_exists")
    def test_cli_get_default_output_directory_selection(
    ...
    @patch("scribe_data.cli.get.query_data")
    def test_cli_get_error_handling_value_error(
        self, mock_query_data: MagicMock
    ) -> None:
        """
