...
def test_cli_convert_translations_to_sqlite(
...
def test_cli_convert_overwrite_existing_file_user_confirms(
    temp_json_dir: Path, translations_setup: dict[str, Any]
) -> None:
    """
...
def test_cli_convert_overwrite_existing_file_user_declines(
    temp_json_dir: Path, translations_setup: dict[str, Any]
) -> None:
    """
...
def test_cli_convert_translations_to_sqlite_missing_json(
...
def test_cli_convert_translations_to_sqlite_commit_error(
    temp_json_dir: Path, translations_setup: dict[str, Any], capsys: Any
) -> None:
    """
...
def test_cli_convert_to_sqlite_invalid_language() -> None:
    """
...
def test_cli_convert_create_table_duplicate_columns(temp_db: Any) -> None:
    """
...
def test_cli_convert_convert_to_sqlite_translations_and_nouns(tmp_path: Path) -> None:
...
def test_cli_convert_convert_to_sqlite_skips_missing_json(tmp_path: Path) -> None:
    input_dir = tmp_path / "input"
    input_dir.mkdir()
...
def test_cli_convert_wiktionary_translations_to_sqlite_basic(tmp_path):
    """
...
def test_cli_convert_wiktionary_translations_to_sqlite_camel_case(tmp_path):
    """
...
def test_cli_convert_wiktionary_translations_to_sqlite_missing_dir(tmp_path, capsys):
    """
    Test wiktionary_translations_to_sqlite with non-existent language directory.
    """
    wiktionary_translations_to_sqlite(language="nonexistent", input_file=str(tmp_path))
