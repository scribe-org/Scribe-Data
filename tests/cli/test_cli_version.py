...
class TestVersionFunctions(unittest.TestCase):
    ...
    def test_cli_version_local_not_installed(self, mock_version: MagicMock) -> None:
        self.assertEqual(get_local_version(), UNKNOWN_VERSION_NOT_PIP)

    @patch("requests.get")
    def test_cli_version_latest(self, mock_get: MagicMock) -> None:
    ...
    def test_cli_version_latest_failure(self, mock_get: MagicMock) -> None:
    ...
    def test_cli_version_message_up_to_date(
