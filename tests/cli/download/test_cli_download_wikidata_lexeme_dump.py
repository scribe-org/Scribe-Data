...
class TestDownloadCLI(unittest.TestCase):
    ...
    def test_cli_download_check_lexeme_dump_prompt_download_existing(
    ...
    def test_cli_download_check_lexeme_dump_prompt_download_delete(
        self, mock_glob: MagicMock, mock_select: MagicMock
    ) -> None:
        """
    ...
    def test_cli_download_wd_lexeme_dump_download_wrapper_default_flag(self) -> None:
        """
