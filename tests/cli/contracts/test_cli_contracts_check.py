...
from scribe_data.cli.contracts.filter import DEFAULT_DATA_CONTRACTS_DIR
...
def test_check_contracts_with_dir(mock_print: MagicMock, mock_check: MagicMock) -> None:
    """
...
@patch("scribe_data.cli.contracts.check.check_contract_data_completeness")
@patch("scribe_data.cli.contracts.check.print_missing_forms")
def test_cli_contracts_check_default_dir(
