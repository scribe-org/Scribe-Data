...
from scribe_data.utils import DEFAULT_DATA_CONTRACTS_DIR

# MARK: Metadata


class TestCLIContractFilterMetaData:
...
class TestCLIContractsFilterExportedData:
...
class TestCLIContractsFilterExport:
    ...
    @patch("json.dump")
    def test_cli_contracts_filter_export_data_filtered_by_contracts(
        self,
        ...
        with patch.object(Path, "glob", mock_path_glob):
            # Call the function.
            export_data_filtered_by_contracts(contracts_dir=DEFAULT_DATA_CONTRACTS_DIR)
    ...
    @patch("os.listdir")
    @patch("pathlib.Path.mkdir")
    def test_cli_contracts_filter_export_data_filtered_by_contracts_no_language_match(
        self,
        mock_mkdir: MagicMock,
        mock_listdir: MagicMock,
        mock_get_language: MagicMock,
    ...
    @patch("pathlib.Path.mkdir")
    @patch("pathlib.Path.exists")
    def test_cli_contracts_filter_export_data_filtered_by_contracts_no_input_file(
        self,
        mock_exists: MagicMock,
        mock_mkdir: MagicMock,
        mock_listdir: MagicMock,
    ...
    @patch("os.listdir")
    @patch("pathlib.Path.mkdir")
    def test_cli_contracts_filter_export_data_filtered_by_contracts_empty_metadata(
        self,
        mock_mkdir: MagicMock,
        mock_listdir: MagicMock,
        mock_get_language: MagicMock,
