...
class TestCLITotalQuery(unittest.TestCase):
    ...
    def test_cli_total_query_valid(
    ...
    @patch("scribe_data.cli.total.query.get_qid_by_input")
    @patch("scribe_data.wikidata.wikidata_utils.sparql.query")
    def test_cli_total_query_no_results(
        self, mock_query: MagicMock, mock_get_qid: MagicMock
    ) -> None:
        mock_get_qid.side_effect = lambda x: {"english": "Q1860", "nouns": "Q1084"}.get(
            x.lower()
    ...
    @patch("scribe_data.cli.total.query.get_qid_by_input")
    @patch("scribe_data.wikidata.wikidata_utils.sparql.query")
    def test_cli_total_query_invalid_language(
        self, mock_query: MagicMock, mock_get_qid: MagicMock
    ) -> None:
    ...
    @patch("scribe_data.cli.total.query.get_qid_by_input")
    @patch("scribe_data.wikidata.wikidata_utils.sparql.query")
    def test_cli_total_query_empty_and_none_inputs(
        self, mock_query: MagicMock, mock_get_qid: MagicMock
    ) -> None:
    ...
    @patch("scribe_data.cli.total.query.get_qid_by_input")
    @patch("scribe_data.wikidata.wikidata_utils.sparql.query")
    def test_cli_total_query_nonexistent_language(
        self, mock_query: MagicMock, mock_get_qid: MagicMock
    ) -> None:
        mock_get_qid.return_value = None
        mock_query.return_value = MagicMock()
    ...
    @patch("scribe_data.cli.total.query.get_qid_by_input")
    @patch("scribe_data.wikidata.wikidata_utils.sparql.query")
    def test_cli_total_query_various_data_types(
        self, mock_query: MagicMock, mock_get_qid: MagicMock
    ) -> None:
    ...
    def test_cli_total_query_sub_languages(
...
class TestGetQidByInput(unittest.TestCase):
    ...
    @patch("scribe_data.utils.data_type_metadata", new_callable=dict)
