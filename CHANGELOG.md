...
- The SPARQL queries for the Scribe-Data CLI are generated by a process that reads data contracts and creates queries to fulfill the contracts ([#669](https://github.com/scribe-org/Scribe-Data/issues/617)).
- The available data on Wikidata can also be audited, with simple contracts for the data being generated to then generate queries from ([#617](https://github.com/scribe-org/Scribe-Data/issues/669)).
